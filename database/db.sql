...
CREATE TABLE MEDICAMENTOS (
    ID_MEDICAMENTO INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, REGISTRO VARCHAR(20) NOT NULL, LABORATORIO VARCHAR(40) NOT NULL, NOMBRE_MEDICAMENTO VARCHAR(100) NOT NULL
);
...
CREATE TABLE CARTILLA_MASCOTAS (
    ID_MASCOTA INT UNSIGNED PRIMARY KEY, ID_MEDICAMENTOS INT UNSIGNED NOT NULL, ULTIMA_DOSIS_APLICADA DATE NOT NULL
);

-- MEDICAMENTOS RECETADOS
CREATE TABLE MEDICAMENTOS_RECETADOS (
    ID_MASCOTA INT UNSIGNED PRIMARY KEY, ID_MEDICAMENTOS INT UNSIGNED NOT NULL, DOSIS_FALTANTES INT UNSIGNED NOT NULL, FRECUENCIA_APLICACION VARCHAR(200), ULTIMA_DOSIS_APLICADA DATE
);

-- CATÁLOGO DE ALIMENTOS
CREATE TABLE CATALOGO_ALIMENTOS (
    ID_ALIMENTOS INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, NOMBRE_ALIMENTO VARCHAR(50) NOT NULL, DESCRIPCION_ALIMENTO VARCHAR(100) NOT NULL
);
-- CUIDADOS RUTINARIOS
CREATE TABLE CUIDADOS_RUTINARIOS (
    ID_MASCOTA INT UNSIGNED PRIMARY KEY, ID_ALIMENTOS INT UNSIGNED NOT NULL, ALERGIAS VARCHAR(255), CONDICIONES_ESPECIALES VARCHAR(255)
);

-- ESPECIES
CREATE TABLE ESPECIES (
    NOMBRE_ESPECIE VARCHAR(50) PRIMARY KEY, DESCRIPCION VARCHAR(255)
);

-- RAZAS
CREATE TABLE RAZAS (
    NOMBRE_RAZA VARCHAR(100) PRIMARY KEY, NOMBRE_ESPECIE VARCHAR(50) NOT NULL
);

-- MASCOTAS
CREATE TABLE MASCOTAS (
    ID_MASCOTA INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, NOMBRE_RAZA VARCHAR(100) NOT NULL, NOMBRE_MASCOTA VARCHAR(100) NOT NULL, TAMANO ENUM(
        "Pequeño", "Mediano", "Grande"
    ) NOT NULL, FECHA_NACIMIENTO DATE, COLOR VARCHAR(20)
);

-- CLIENTES
CREATE TABLE CLIENTES (
    CURP VARCHAR(19) PRIMARY KEY, NOMBRES TINYTEXT, PRIMER_APELLIDO TINYTEXT, SEGUNDO_APELLIDO TINYTEXT
);
...
CREATE TABLE NUMEROS_TELEFONICOS (
    CURP VARCHAR(19), NUMERO_TELEFONICO INT UNSIGNED PRIMARY KEY
);
...
CREATE TABLE CORREOS_ELECTRONICOS (
    CURP VARCHAR(19), CORREO_ELECTRONICO VARCHAR(100) PRIMARY KEY
);
...
CREATE TABLE DIRECCIONES_REFERENCIA (
    CURP VARCHAR(19) NOT NULL, CALLE VARCHAR(100) NOT NULL, NUMERO_EXTERIOR INT UNSIGNED NOT NULL, NUMERO_INTERIOR INT UNSIGNED, COLONIA TINYTEXT NOT NULL, CODIGO_POSTAL INT UNSIGNED NOT NULL, MUNICIPIO_ALCALDIA TINYTEXT NOT NULL, ESTADO TINYTEXT NOT NULL
);

-- RESERVACIÓN
CREATE TABLE RESERVACION (
    ID_RESERVACION INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, ID_MASCOTA INT UNSIGNED NOT NULL, CURP VARCHAR(19) NOT NULL
);

-- CATÁLOGO DE CUARTOS
CREATE TABLE CATALOGO_CUARTOS (
    ID_TIPO_CUARTO INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, NOMBRE_CUARTO VARCHAR(50) NOT NULL, TAMANO ENUM(
        "Pequeño", "Mediano", "Grande"
    ) NOT NULL, PRECIO_CUARTO INT UNSIGNED NOT NULL
);

-- SUCURSALES
CREATE TABLE SUCURSALES (
    ID_SUCURSAL INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, CIUDAD_UBICACION TINYTEXT NOT NULL
);

-- CUARTOS
CREATE TABLE CUARTOS (
    ID_CUARTO INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, ID_TIPO_CUARTO INT UNSIGNED NOT NULL, ID_SUCURSAL INT UNSIGNED NOT NULL, NUMERO_CUARTO VARCHAR(10) NOT NULL
);
...
CREATE TABLE HOSPEDAJE (
    ID_HOSPEDAJE INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, ID_RESERVACION INT UNSIGNED NOT NULL, ID_CUARTO INT UNSIGNED NOT NULL, CHECK_IN DATETIME NOT NULL, CHECK_OUT DATETIME NOT NULL, TOTAL_SERVICIOS INT UNSIGNED NOT NULL, TOTAL_CUARTO INT UNSIGNED NOT NULL, CORTE INT UNSIGNED NOT NULL, EQUIPAJE_TRANSPORTE BOOLEAN NOT NULL DEFAULT 0
);

-- RESEÑAS DEL HOTEL
CREATE TABLE RESENAS_HOTEL (
    ID_RESENA_HOTEL INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, ID_SUCURSAL INT UNSIGNED NOT NULL, ID_HOSPEDAJE INT UNSIGNED NOT NULL, DESCRIPCION TINYTEXT NOT NULL, CALIFICACION FLOAT(3, 2) UNSIGNED NOT NULL
);

-- EMPLEADOS DE TODAS LAS SUCURSALES
CREATE TABLE EMPLEADOS (
    ID_EMPLEADO INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, NOMBRES TINYTEXT NOT NULL, PRIMER_APELLIDO TINYTEXT NOT NULL, SEGUNDO_APELLIDO TINYTEXT NOT NULL, NUMERO_CONTACTO INT UNSIGNED NOT NULL
);
...
CREATE TABLE SUC_EMP (
    ID_SUCURSAL INT UNSIGNED NOT NULL, ID_EMPLEADO INT UNSIGNED NOT NULL
);

-- CATÁLOGO DE SERVICIOS
CREATE TABLE CATALOGO_SERVICIOS (
    ID_SERVICIO INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, NOMBRE_SERVICIO TINYTEXT NOT NULL, COSTO_BASE INT UNSIGNED NOT NULL, COSTO_EXTRA INT UNSIGNED
);

-- CITAS POR AGENDAR
CREATE TABLE CITAS (
    ID_CITA INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, ID_HOSPEDAJE INT UNSIGNED NOT NULL, ID_SERVICIO INT UNSIGNED NOT NULL, ID_EMPLEADO INT UNSIGNED NOT NULL, FECHA_CITA DATETIME NOT NULL, COSTO_TOTAL INT UNSIGNED NOT NULL
);

-- RESEÑAS DE LOS SERVICIOS CON CITA DE LOS CLIENTES
CREATE TABLE RESENAS_CITAS (
    ID_RESENA_CITA INT UNSIGNED PRIMARY KEY AUTO_INCREMENT, ID_CITA INT UNSIGNED NOT NULL, ID_HOSPEDAJE INT UNSIGNED NOT NULL, CALIFICACION INT UNSIGNED, DESCRIPCION VARCHAR(255)
);
