...
%\input{iu/iu-template}
\input{iu/iu-registrarCliente}
\input{iu/iu-registrarMascota}
\input{iu/iu-registrarDatosMascota}
\input{iu/iu-mainPage}
\input{iu/iu-homeCliente}
\input{iu/iu-busquedaHospedajes}
\input{iu/iu-catalogoHabitaciones}
\input{iu/iu-vistaGeneralCuarto}
\input{iu/iu-serviciosAdicionales}
\input{iu/iu-registrarMasDetalles}
\input{iu/iu-resumenHospedaje}
